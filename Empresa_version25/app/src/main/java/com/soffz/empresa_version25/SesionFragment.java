...
public class SesionFragment extends Fragment implements Response.Listener<JSONObject>,Response.ErrorListener {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        jtvregistrar.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intregistrar = new Intent(getContext(),UsuariosActivity.class);
    ...
    private void Iniciar_sesion() {
        ...
        if (correo.isEmpty() || clave.isEmpty()) {
            Toast.makeText(getContext(), "Correo y la clave son requeridos", Toast.LENGTH_SHORT).show();
            jetcorreo.requestFocus();
        } else {
            String url = "http://172.16.59.102:80/Empresa6/ingreso.php?correo=" + jetcorreo.getText().toString() + "&clave=" + jetclave.getText().toString();
